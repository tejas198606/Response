...
# Load model
cnn_model = tf.keras.models.load_model(STATIC_FOLDER + "/models/" + "Malaria11.h5")  
## static folder inside model folder and save model 


IMAGE_SIZE = 192                                            ## Image Size can be changed 
...
@app.route("/")
def home():
    return render_template("home00.html")                    ## HOME.HTML IS THE TEMPLATE NAME // it can be anything home11.html
...
def upload_file():
    ...
    return render_template(
        "classify00.html", image_file_name=file.filename, label=label, prob=prob) 
